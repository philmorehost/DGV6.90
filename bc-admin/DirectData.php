      ...
      <div class="row g-4">
        <?php
            ...
            while($api_row = mysqli_fetch_assoc($check_fetcher_query)){
                ...
                $is_local = (mysqli_num_rows(mysqli_query($connection_server, "SELECT id FROM sas_vendors WHERE website_url='$url'")) > 0);
                    ...
                    <div class="collapse mb-3" id="fetcherGuide">
                        <div class="alert alert-info border-0 shadow-sm rounded-4 mb-0">
                            ...
                            <ol class="small mb-0 text-dark">
                                ...
                                <li>Enter your desired <strong>Discount/Profit</strong> percentages (e.g., set Smart % to 5 to give 5% discount).</li>
