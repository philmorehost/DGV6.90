...
$model      = $get_logged_admin_details["ai_model_assigned"] ?? "phi4-mini";
        ...
        <div class="col-lg-7">
            <div class="d-flex align-items-center mb-3">
                ...
                <div>
                    ...
                    <small class="opacity-75">Powered by Ollama · Private · Local · Fast</small>
                </div>
            </div>
            <p class="opacity-90 mb-3">Unlock AI-powered transaction security, smart business guides, marketing copy generation, and voice-to-VTU commands. All data stays on your server — never shared with third parties.</p>
