...
<?php include("../func/bc-admin-header.php"); ?>
    ...
    <div class="text-center mb-5">
        <div class="nav nav-tabs-ai shadow-sm" role="tablist">
            <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#tab-overview">Intelligence Hub</button>
            <button class="nav-link" data-bs-toggle="tab" data-bs-target="#tab-commerce">Commerce & Tokens</button>
    ...
    <div class="tab-content animate__animated animate__fadeInUp">
        ...
        <!-- COMMERCE TAB -->
        <div class="tab-pane fade" id="tab-commerce">
            <div class="row g-4">
                <div class="col-md-6">
