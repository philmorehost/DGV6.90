                ...
                <form method="get" action="MarketPlace.php" class="row g-2">
                    <div class="col-md-10">
                        <div class="input-group">
                            ...
                            <input name="searchq" type="text" value="<?php echo trim(strip_tags($_GET["searchq"])); ?>" placeholder="Search by Product Name, API Website, Type..." class="form-control border-start-0" />
                        </div>
                    </div>
                    <div class="col-md-2">
