...
<!-- ======= Header ======= -->
  ...
  <aside id="sidebar" class="sidebar">
    ...
    ?>
      ...
      <li class="nav-item">
        <?php $manage_billing_active = in_array($current_page, ['BillingPackages.php', 'CreateBilling.php', 'Billings.php', 'AllSubscriptions.php']); ?>
        ...
        <ul id="manage-billing-nav" class="nav-content collapse <?php echo $manage_billing_active ? 'show' : ''; ?>" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="<?php echo $web_http_host; ?>/bc-spadmin/CreateBilling.php" class="<?php echo ($current_page == 'CreateBilling.php') ? 'active' : ''; ?>">
              <i class="bi bi-circle"></i><span>Add Billing</span>
            </a>
          </li>
          <li>
            <a href="<?php echo $web_http_host; ?>/bc-spadmin/Billings.php" class="<?php echo ($current_page == 'Billings.php') ? 'active' : ''; ?>">
