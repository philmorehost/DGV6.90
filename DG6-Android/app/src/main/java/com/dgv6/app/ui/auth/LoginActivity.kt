...
import com.dgv6.app.databinding.ActivityLoginBinding
...
import com.dgv6.app.util.hide
import com.dgv6.app.util.show
import com.dgv6.app.util.showSnack
...
class LoginActivity : AppCompatActivity() {
    ...
    private fun showBiometricPrompt() {
        ...
        val promptInfo = BiometricPrompt.PromptInfo.Builder()
            ...
            .setSubtitle("Authenticate to access DataGifting")
        ...
        FirebaseMessaging.getInstance().token.addOnSuccessListener { token ->
            if (token.isNotEmpty()) {
                ...
                lifecycleScope.launch {
                    try {
                        com.dgv6.app.api.RetrofitClient.getService()
