...
$ai_tables = ['sas_ai_transactions', 'sas_ai_audit_log', 'sas_ai_whitelist', 'sas_whatsapp_gateway', 'sas_rate_limits', 'sas_ai_page_guides'];
...
echo "\n[ CRON JOBS ]\n";
$cron_files = [
    'cron/ai_model_check.php'       => 'Model Check (every 1m)',
